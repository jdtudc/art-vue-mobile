...
(function (window, document, Math) {
  ...
  */
  ...
  function IScroll (el, options) {
    ...
    this.options.click = fixIScrollClickInAndriod()
    /** fix click in bad Andriod
	 * @date 2019/1/16
	 * @mail chenjiahao@jd.com
	 **/
    function fixIScrollClickInAndriod () {
      ...
      if (/Android/i.test(navigator.userAgent)) {
        ...
        return !!(parseFloat(s[0] + s[2] + s[4]) <= 442 && parseFloat(s[0] + s[2] + s[4]) > 430)
      }
    }
  ...
  IScroll.prototype = {
    ...
    _wheel: function (e) {
      ...
      var wheelDeltaX; var wheelDeltaY
